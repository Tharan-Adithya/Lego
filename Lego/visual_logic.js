 ...
 * Thu Apr 18 2024 19:04:01 GMT+0530 (India Standard Time)
...
var l, cubes, x, history2, k, dictionary, j, obj, obj1, o, z, save, m, n, xx, newpiece, y;
...
function drag(x) {
  ...
  registerOnDrag(x, false, [0], function() {}, function() {
    dragMove(x, 'XYZ', 'R7Ddss(6#)+pAS~RittM', 'g{nzw+|hR50oF?3O/?gz');
  }, function() {
    dictSet(dictionary, x, getObjTransform(x, false, 'position', 'xyz'));
  }, 'g{nzw+|hR50oF?3O/?gz');
}

// Describe this function...
function drag2(x) {
  objConstraintAddLimit(x, x, 'POS_Z', 4, 500, '', 0, 'LIMITDIST_ONSURFACE');
  registerOnDrag(x, false, [0], function() {}, function() {
    dragMove(x, 'XYZ', 'y%y+(D;avc);i!J_?%bj', '~D}=:B3o~F2Y{B|6D/]c');
  }, function() {
    dictSet(dictionary, x, getObjTransform(x, false, 'position', 'xyz'));
  }, '~D}=:B3o~F2Y{B|6D/]c');
}
...
z = 0;
m = 0;
addHTMLElement('button', 'button', 'TO', ['CONTAINER'], true);
setHTMLElemStyle('backgroundColor', 'red', 'button', true);
setHTMLElemStyle('height', '50px', 'button', true);
setHTMLElemStyle('width', '50px', 'button', true);
setHTMLElemStyle('alignItems', 'center', 'button', true);
eventHTMLElem('click', 'button', true, function(event) {
...
addHTMLElement('button', 'btn2', 'TO', ['CONTAINER'], true);
setHTMLElemStyle('backgroundColor', 'pink', 'btn2', true);
setHTMLElemStyle('height', '50px', 'btn2', true);
setHTMLElemStyle('width', '50px', 'btn2', true);
eventHTMLElem('click', 'btn2', true, function(event) {
  y = cloneObject('6cube');
...
addHTMLElement('button', 'btn3', 'TO', ['CONTAINER'], true);
setHTMLElemStyle('backgroundColor', 'green', 'btn3', true);
setHTMLElemStyle('height', '50px', 'btn3', true);
setHTMLElemStyle('width', '50px', 'btn3', true);
eventHTMLElem('click', 'btn3', true, function(event) {
  n = cloneObject('8cube');
...
addHTMLElement('button', 'save', 'TO', ['CONTAINER'], true);
setHTMLElemStyle('backgroundColor', 'yellow', 'save', true);
setHTMLElemStyle('height', '50px', 'save', true);
setHTMLElemStyle('width', '50px', 'save', true);
eventHTMLElem('click', 'save', true, function(event) {
  downloadFile(dictionary, 'data.json');
});

history2 = 'empty';
addHTMLElement('button', 'load', 'TO', ['CONTAINER'], true);
setHTMLElemStyle('backgroundColor', 'brown', 'load', true);
setHTMLElemStyle('height', '50px', 'load', true);
setHTMLElemStyle('width', '50px', 'load', true);
